...
class calCPA:
    ...
    #alpha
    def calculate_alpha(self, vR_x, vR_y):
    ...
    #他船相对本船的相对速度航向phi
    def calculate_phi(self, vR_x, vR_y, alpha):
    ...
    #方位alpha_t
    def calculate_alpha_t(self, delta_x,delta_y, alpha):
    ...
    def getCPA(self):
        ...
        alpha = self.calculate_alpha(vR_x, vR_y)

        #相对速度航向
        phi = self.calculate_phi(vR_x, vR_y, alpha)
        ...
        #他船相对于本船的真方位
        alpha_T = self.calculate_alpha_t(delta_x, delta_y, alpha)
...
listA = np.array([[123456789, 120.5, 25.6, 45.0, 10.0, 90.0, 50.0, 15.0, 123]])
listB = np.array([[987654321, 121.0, 25.8, 120.0, 8.0, 120.0, 40.0, 12.0, 321]])
